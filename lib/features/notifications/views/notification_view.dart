...
import 'package:todoapp/features/notifications/widgets/notification_tile.dart';
                  ...
                  return ref.watch(getLatestNotificationProvider).when(
                        data: (data) {
                          if (data.events.contains(
                            'databases.*.collections.${AppwriteContants.notificationCollection}.documents.*.create',
                          )) {
                            final latestNotif =
